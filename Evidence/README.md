...
이 디렉토리는 빙결사 핵심 결함(**방어구 마스터리 스탯 역전** 및 **헤일스톰 타격 판정 누락**)을 증명하기 위한 조건별 스크린샷과 데이터를 관리합니다.
...
| :--- | :--- | :--- | :--- |
| **BUG-001** | 방어구 마스터리 | 25Lv 장비 착용 시 HP 역전 현상 | 데이터 테이블 내 계수 값 누락 |
